...
?>
				...
				<div class="main-content-inner">
					<div class="breadcrumbs" id="breadcrumbs">
						...
						<ul class="breadcrumb">
							...
							<li>Listagem</li>
							<li class="active"><a href="lista?filter=Desistiu">Desist&ecirc;ncias</a></li>
						</ul><!-- /.breadcrumb -->
							...
							<h1>
								...
								<small>
									...
									if (isset($_GET["filter"])== "Deistiu" or "$hoje" ) { 
										echo "Desist&ecirc;ncias";
									} else  {
										echo "Perm&acirc;ncia";
									}
									?>
								</small>
							</h1>
			...
			if (isset($_GET["data"])){
				$q = " AND espera='Desistiu' AND data LIKE '%".$_GET["data"]."%' ";
                        }
						
			if (isset($_GET["jogadores"])){
				$q = " AND espera='Nao' AND ativo='0' AND data LIKE '%".$_GET["jogadores"]."%'";
                        }
		...
		<script type="text/javascript">
			jQuery(function($) {
				...
				.dataTable( {
					...
					"aoColumns": [
					  { "bSortable": false },
					  null, null,null, null, null, null,null, <?php if($_GET["block"]==1) echo "null,";?>
