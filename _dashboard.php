                                ...
                                <div class="infobox-data">
                                    ...
                                    <div class="infobox-content">
                                        <span class="bigger-110">
                                            <a href="lista?jogadores=<?php echo $cx_id ?>">
                                                jogadores hoje
                                            </a>
                                        </span>
...
////////// Function
                            ...
                            <div class="infobox infobox-green  infobox-dark">
                                <div class="infobox-progress">
                                    <div class="easy-pie-chart percentage" data-percent="<?php if (empty($percent_compra)) {
                                            echo 0;
                                        } else {
                                            echo $percent_compra;
                                        } ?>" data-size="49">
                                        <span class="percent"><?php if (empty($percent_compra)) {
                                            echo 0;
                                        } else {
                                            echo $percent_compra;
                                        } ?></span>%
                            ...
                            <div class="infobox infobox-wood  infobox-dark">
                                ...
                                <div class="infobox-data">
                                    <div class="infobox-content">Ficheiro</div>
                                    <div class="infobox-data-number">
                                        <?php
                                        if (empty($ficheiro)) {
                                            echo 0;
...
<?php } ?>
                                                                    ...
                                                                    <input type="hidden" name="e_data" value="<?php echo $e_data ?>" />
                                                                    <input type="hidden" name="c_data" value="<?php echo $data_e ?>" />
                                                                    <input type="hidden" name="p_nome" value="<?php echo $p_nome ?>" />
                                                                </div>
