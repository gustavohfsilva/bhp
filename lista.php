...
$sec = "Controle";
if ($_GET["filter"] <> D) $page = "Jogadores";
if ($_GET["filter"] <> J) $page = "Desist&ecirc;ncias";
                ...
                <div class="breadcrumbs" id="breadcrumbs">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active"> <?php
                            if ($_GET["filter"]==="J") {
                                echo $page;
                            } elseif ($_GET["filter"]=== "D") {
                                echo '<a href="lista?id=' . $cx_id . '">' .$page. ' hoje</a>';
                            } else {
                                echo '<a href="lista?filter=D">' .$page. ' geral</a>';  
                            }
                            ?></li>
