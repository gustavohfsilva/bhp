                                    ...
                                    <table id="dynamic-table" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <i class="ace-icon fa fa-address-card-o red bigger-110 hidden-480"></i>
                                                    RG
                                                </th>
                                                ...
                                                <th class="hidden-480">
                                                    <i class="ace-icon fa fa-money red bigger-110 hidden-480"></i>
                                                    Limite
                                                </th>
                                                <th>
                                                    <i class="ace-icon fa fa-phone red bigger-110 hidden-480"></i>
                                                    Telefone
                                                </th>

                                                <th>
                                                    <i class="ace-icon fa fa-envelope red bigger-110 hidden-480"></i>
                                                    E-mail
                                                </th>

                                                <th>
                                                    <i class="ace-icon fa fa-yelp red bigger-110 hidden-480"></i>
                                                    Idade
                                                </th>
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT * from cadastro_pessoa where cd_tipo='Fidelidade'";
